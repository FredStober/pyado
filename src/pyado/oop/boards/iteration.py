...
class Iteration:
    ...
    :meth:`ProjectBoards.get_iteration_node`.
    ...
    children at a specific depth, call :meth:`ProjectBoards.get_iteration_node`
    ...
    def children(self) -> "list[Iteration]":
        ...
        :meth:`ProjectBoards.get_iteration_node` with a higher *depth* to
        populate children.
        """
