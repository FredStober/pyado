...
from pyado.oop._git import _full_ref
...
def link_pull_request_work_item(
    ...
    *,
    ...
    work items list (``iter_pull_request_work_item_ids``).
    ...
    *,
    ...
    Args:
        ...
        work_item_ids: Optional list of work item IDs to link to the PR at
            ...
            the linked items are immediately visible via
    ...
    *,
    ...
    Args:
        ...
        last_merge_source_commit: Current HEAD SHA of the source branch.
            ...
            ``get_pull_request_details(pr_api_call).last_merge_source_commit.commit_id``.
...
def update_pull_request_work_item_refs(
    ...
    item side, call :func:`link_pull_request_work_item` for each item.
